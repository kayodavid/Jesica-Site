...
create table if not exists public.questionnaire_schedules (
  ...
  status text not null default 'aguardando_brevo'
    check (status in ('aguardando_brevo', 'tentando_agendar', 'agendado_na_brevo', 'falha_de_agendamento', 'pausado', 'enviado', 'entregue', 'cancelado', 'expirado')),
