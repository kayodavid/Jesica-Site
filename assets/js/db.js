...
export const db = {
  ...
  async updateSection(id, name, coverImage = '') { try { return await rpc('app_update_section', { p_token: token(), p_id: id, p_name: name.trim(), p_cover_image: coverImage }); } catch { return { success: false, message: 'Não foi possível atualizar a seção.' }; } },
