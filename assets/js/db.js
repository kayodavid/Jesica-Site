...
export const db = {
  ...
  async getBlogs() { try { return (await rpc('app_list_blogs', { p_token: token() }) || []).map(normalizeBlog).sort((a, b) => new Date(b.createdAt || b.updatedAt || 0) - new Date(a.createdAt || a.updatedAt || 0)); } catch { return []; } },
